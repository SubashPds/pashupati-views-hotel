...
class PackageController extends Controller
{
    ...
    private function validatePackage(Request $request, ?int $ignoreId = null): array
    {
        $validated = $request->validate([
            ...
            'price_from'        => 'nullable|numeric|decimal:0,2|min:0|max:99999999.99',
            'duration'          => 'nullable|string|max:100',
            'min_guests'        => 'nullable|integer|min:1|max:127',
            'max_guests'        => ['nullable', 'integer', 'min:1', 'max:127', ...($request->filled('min_guests') ? ['gte:min_guests'] : [])],
