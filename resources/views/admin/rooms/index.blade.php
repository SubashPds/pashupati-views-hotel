...
<div role="region" aria-label="Rooms table" tabindex="0" class="rounded-2xl bg-white/5 border border-white/8 overflow-x-auto focus-visible:outline-2 focus-visible:outline-violet-400">
