...
<div class="overflow-hidden rounded-2xl border border-gold/15 bg-white shadow-sm">
    <iframe src="{{ $mapUrl }}" title="Map showing {{ $hotelName }} location"
            class="block h-64 w-full border-0 bg-ivory sm:h-80"
            loading="lazy" referrerpolicy="no-referrer-when-downgrade" allowfullscreen></iframe>
    <div class="flex items-center justify-end border-t border-gold/10 px-5 py-3 sm:px-6">
