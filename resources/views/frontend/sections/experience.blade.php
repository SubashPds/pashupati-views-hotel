...
<section id="experience" class="py-24" style="background:#fffdf9;">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="group p-6 rounded-2xl border border-gold/15 hover:border-gold/30 hover:shadow-lg transition-all duration-300"
