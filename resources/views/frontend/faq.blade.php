...
<div class="faq-hero relative overflow-hidden bg-ivory">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="gallery-collection-heading pb-3 mt-2 border-b border-gold/20">
            <div>
    ...
    <div class="max-w-4xl mx-auto px-6 sm:px-10 lg:px-8">
        ...
        <div class="py-28 text-center">
            ...
            <p class="text-gray-500 text-sm">We're working on it.
                <a href="#contact" class="underline underline-offset-2 font-medium text-[#b8953b]">Contact us</a> in the meantime.
            </p>
        </div>
