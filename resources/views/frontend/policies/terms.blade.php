@extends('layouts.app')
@section('title', 'Terms & Conditions — ' . ($settings['site_name'] ?? 'Pashupati Views Hotel'))
@section('meta_description', 'Read Pashupati Views Hotel\'s Terms & Conditions.')
    ...
    <div class="max-w-4xl mx-auto px-6 sm:px-10 lg:px-8">
        <div class="rounded-2xl overflow-hidden flex flex-col sm:flex-row items-center gap-8 px-8 py-12 sm:py-14 bg-white border border-[rgba(184,149,59,0.15)] shadow-[0_4px_20px_rgba(184,149,59,0.08)]">
            <div class="flex-1 text-center sm:text-left">
                ...
                <p class="text-gray-600 text-sm mt-2">Reach out if you have any questions or concerns about our terms.</p>
            </div>
